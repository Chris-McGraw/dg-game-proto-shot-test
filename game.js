...
/* ------------------------- Function Declarations ------------------------- */
  ...
  function changeShotType() {
    if(shotType === "backhand") {
      ...
      svgPath.setAttribute("d", shotPreviewArrayForehand[currentArray].d);
      ...
      svgPath.setAttribute("d", shotPreviewArrayBackhand[currentArray].d);
  ...
  function moveShotPreviewUp() {
    ...
    /* ----- Shot Preview Pointer Up ----- */
      ...
      if(shotType === "backhand") {
        ...
        $shotPathPreview.css("stroke-dashoffset", shotPreviewArrayBackhand[currentArray + 1].strokeDashOffset);

        svgMain.setAttribute("width", shotPreviewArrayBackhand[currentArray + 1].width);
        svgMain.setAttribute("height", shotPreviewArrayBackhand[currentArray + 1].height);
        svgMain.setAttribute("viewBox", shotPreviewArrayBackhand[currentArray + 1].viewBox);

        svgG.setAttribute("transform", shotPreviewArrayBackhand[currentArray + 1].transform);

        svgPath.setAttribute("d", shotPreviewArrayBackhand[currentArray + 1].d);
      }
      else if(shotType === "forehand") {
        $shotPathPreview.css("top", shotPathHeightForehand);
        $shotPathPreview.css("stroke-dashoffset", shotPreviewArrayForehand[currentArray + 1].strokeDashOffset);

        svgMain.setAttribute("width", shotPreviewArrayForehand[currentArray + 1].width);
        svgMain.setAttribute("height", shotPreviewArrayForehand[currentArray + 1].height);
        svgMain.setAttribute("viewBox", shotPreviewArrayForehand[currentArray + 1].viewBox);

        svgG.setAttribute("transform", shotPreviewArrayForehand[currentArray + 1].transform);

        svgPath.setAttribute("d", shotPreviewArrayForehand[currentArray + 1].d);
      }
